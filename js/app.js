...
/* Version 4.7 | 2026-06-25 | 注册错误透传 + email确认检测 */

// 前端版本标记 - 打开控制台（F12）可查看当前加载版本
console.log('%c[专家资源库 v4.7] 加载时间: ' + new Date().toLocaleString() + ' | Supabase Cloud', 'color:#059669;font-weight:700;font-size:13px;');
