...
var VERSION_CHANGELOG = [
  { version: 'v5.9.3', date: '2026-08-11', summary: '专家卡评分星标改为带材质填充星+轻量标签（紫/蓝/橙），提升质感与辨识度。评分规则缺失默认值从3★调整为2★，总览表取消综合得分列，真实案例按新规则重新核算。观察库操作记录重构：新增全局操作审计区（主看全部/子看自己），单专家历次调分入口移至子维度评分区；系统自动操作标记为「系统」。月报新增Section⑤观察库操作明细。', module: '评分系统/观察库/月报' },
